...
var ViewHelp = function (_React$Component) {
    _inherits(ViewHelp, _React$Component);
    ...
    function ViewHelp() {
        ...
        _classCallCheck(this, ViewHelp);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ViewHelp.__proto__ || Object.getPrototypeOf(ViewHelp)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            text: null,
            progress: 0
    ...
    _createClass(ViewHelp, [{
        key: "componentDidMount",
        value: function componentDidMount() {
            var _this3 = this;

            this._handleProgress(true, function () {
                _this3.props.api.pickMetadata("help-text").then(function (_ref3) {
