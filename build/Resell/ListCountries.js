    ...
    _createClass(ListCountries, [{
        ...
        value: function componentDidMount() {
            ...
            this._handleProgress(true, function () {
                _this3.props.api.reseller.collectProviders().then(function (providers) {
                    providers = providers.map(function (_ref3) {
                        var pid = _ref3.pid;

                        return pid;
                    });

                    _this3.props.api.collectProviders(providers, null).then(function (providers) {
                        var countries = providers.map(function (_ref4) {
                            var country = _ref4.country;

                            return country;
                        });

                        _this3.props.api.collectCountries(countries).then(function (countries) {
                            _this3.setState({
                                countries: countries
                            }, function () {
