...
class SetProductBlock extends React.Component {
    ...
    render() {
        ...
        if (this.state.edit === false) {
            ...
            // Stripe fee
            const amountWithFee = (send.amount + 0.30) / (1 - 0.029);
            const fee = amountWithFee - send.amount;
                ...
                <Preview
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Text>
                                    {send.amount.toFixed(2)} {send.currency}
                                </Text>
                                <Text
                                    style={{
                                        color: "#999"
                                ...
                                >
                                    {round(fee, 2).toFixed(2)} {send.currency}
                                </Text>
                                <Text>
                                    {round(send.amount + fee, 2).toFixed(2)} {send.currency}
                                </Text>
                            </Container>
                        </Container>
                        <Container
            ...
            {this.state.products.map((product) => {
                ...
                return product.combinations.map((combination) => {
                    ...
                    return <Row
                        ...
                        >
                            <Text>
                                Envía {send.amount} {send.currency}
                            </Text>
                            <Text
                                style={{
                                    color: "#848484",
